 ...
 <a class='ww' href="fypEditItem2.php">THE TROUSERS</a>
	...
	<?php
	    ...
	    if (isset($_POST['submit'])) {
	        ...
	        $sql = "INSERT INTO item2 (itemName, itemPrice,itemQuantity, itemPic,itemSize) VALUES ('$itemName','$itemPrice',100,'$ipc','$itemSize')
";
