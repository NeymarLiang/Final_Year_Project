<?php
	...
	// $sql = "INSERT INTO item2 (itemID, itemName, itemPrice, itemQuantity, itemPic, itemSize)
	// 		VALUES (12, 'MESH SWEATPANTS', 71.00, 100, 'g20.jpg', 'S,M,L')";
...
<!-- <?php
	...
	if (isset($_POST['addToCart'])) {
	    ...
	    exit;
			...
			$sql = "INSERT INTO cart (customerID, itemID, itemName, itemPrice, itemPic)
			        VALUES ('$customerID', '$itemID', '$itemName', '$itemPrice', '$itemPic')";
...
<body>
	...
	<center>
		<div class="category">
			<a href="fypShop.php" class="c">UPPER OUTER GARMENT</a>&nbsp;&nbsp;<p>/</p>&nbsp;&nbsp;<a href="fypShop2.php" class="c">THE TROUSERS</a>
		</div>
		<br>
		<br>
		<form method="post" action="fypViewItem2.php">
		        ...
		        <?php
		            ...
		            if ($result->num_rows > 0) {
		                ...
		                while($row = $result->fetch_assoc()) {
		                    ...
		                    echo '<p class="p">Price: RM ' . $row["itemPrice"] . '</p>';

		                    echo '<form method="POST" action="fypViewItem2.php">';
