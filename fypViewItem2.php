    ...
    <div class="c">
        <?php
            ...
            if (isset($_POST['search'])) {
                ...
                $sql = "SELECT * FROM item2 WHERE itemName = ?"; 
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<script>alert('Item Not Found'); window.location='fypShop2.php';</script>";
            ...
            if (isset($_POST['viewItem'])) {
                ...
                $sql = "SELECT * FROM item2 WHERE itemID = $itemID"; 
